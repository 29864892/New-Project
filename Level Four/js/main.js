...
window.onload = function() {
    ...
    function preload ()
    {
		...
		this.load.image('bullet', 'assets/eBullet1.png');
		...
		//tilemap preload
		this.load.tilemapTiledJSON('map', 'assets/level4.json');
		this.load.spritesheet('tiles', 'assets/lvl4map.png', {frameWidth: 50, frameHeight: 50});
    }
    ...
    function create ()
    {
		...
		enemy = this.physics.add.sprite(1380,340, 'boss');
		...
		ball = this.physics.add.sprite(1280,345, 'ballSprite');
		...
		officer = this.physics.add.sprite(1300, 500, 'minion');
		bullet = this.physics.add.sprite(1250, 500, 'bullet');
		bullet.body.setAllowGravity(false);
		this.physics.add.overlap(officer, player, hit, null, this);
		this.physics.add.overlap(bullet, player, hit, null, this);
		officer.body.setAllowGravity(false);
	}
